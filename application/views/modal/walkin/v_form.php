...
<form role="form" data-toggle="validator" method="POST" class="frm_data" id="frm_data">
    ...
    <div class="modal-body">
        ...
        <div class="row mb-3">
            ...
            <div class="form-group col">
                <label>Huésped</label>
                <input type="text" name="guest" value="<?=$guest?>"  autofocus required class="form-control imput_reset text-center" autocomplete="off">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="form-group col">
                ...
                <input type="text" name="percentage" id="percentage" value="<?=$percentage?>" readonly autofocus required class="form-control imput_reset text-center porcentaje" autocomplete="off">
            </div>
        ...
        <div class="row mb-3">
            <div class="form-group col">
                ...
                <input type="text" name="number_booking" value="<?=$number_booking?>"  autofocus required class="form-control imput_reset " autocomplete="off">
            </div>
