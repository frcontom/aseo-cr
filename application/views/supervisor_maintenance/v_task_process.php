                ...
                <div class="card-body">
                    <div class="fade show ">
                        <div class="row all_filials" id="all_filials" data-id="<?=$statu->s_id?>">
                            <?php $this->load->view('supervisor_maintenance/v_work_process',['timer' => $timer,'status' => $status_filial, 'filials' => $this->class_security->filter_all($filials,'m_status',$statu->s_id)]); ?>
                        </div>
                    </div>
                </div>
            </div>
