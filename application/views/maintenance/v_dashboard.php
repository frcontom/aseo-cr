...
//print_r($filials);
//filters filials by status or dates
...
?>
     ...
     <div class="col-xl-12 col-xxl-12 col-lg-12 ">
        <div class="card">
            ...
            <div class="card-body">
                <div class="fade show ">
                    <div class="row " id="all_filials" data-id="<?=$statu->s_id?>">
                         <?php $this->load->view('maintenance/v_work',['timer' => $timer,'status' => $status_filial, 'filials' => $this->class_security->filter_all($filials,'m_status',$statu->s_id)]); ?>
                    </div>
                </div>
            </div>
        </div>
