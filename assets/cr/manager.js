                    ...
                    let template = `
                                <div class="media pb-3   mb-1">
                                    <div class="media-body">
                                        ...
                                        <p class="fs-16 mb-2"><b>Tipo de Cliente:</b> ${item.type_event}</p>`;


                    template +=     (item.type_event_box.length > 3) ? `<p class="fs-16 mb-2"><b>Tipo Alimentación:</b> ${item.type_event_box}</p>` : '';


                    template +=     `  <p class="fs-16 mb-2"><b>Vendedor:</b> ${item.seller}</p>
